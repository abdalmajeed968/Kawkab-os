...
export function ReverseBoxMovementButton({ movementId, alreadyReversed }: { movementId: string; alreadyReversed: boolean }) {
  ...
  async function handleReverse() {
    ...
    setSubmitting(true);
    const res = await fetch(`/api/box-movements/${movementId}/reverse`, {
      method: "POST",
